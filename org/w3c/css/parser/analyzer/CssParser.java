...
n.image = Util.strip(n.image);
  ...
  private boolean jj_3R_187()
 {
  ...
  private int jj_la;
  private int jj_gen;
  final private int[] jj_la1 = new int[256];
  ...
  public CssParser(java.io.InputStream stream, String encoding) {
    ...
    jj_ntk = -1;
    jj_gen = 0;
    for (int i = 0; i < 256; i++) jj_la1[i] = -1;
